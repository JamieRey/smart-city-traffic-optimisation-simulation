...
sumoCmd = [sumoBinary, "-c", "SUMO/sameDirectionTrafficDistance.sumocfg"]
...
while tr.simulation.getMinExpectedNumber() > 0:
    ...
    if len(vhclIds) > 0:
        ...
        for SPC in SPCS:
            vhclMthds.canVhclOvertake(SPC, AVhcls, "SUMO/singleRoad.net.xml")

        for SPCO in SPCOS:
            vhclMthds.canVhclRtrnToLane(SPCO, AVhcls, "SUMO/singleRoad.net.xml")
